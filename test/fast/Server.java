 ...
 * This server is designed to be executed as a syncDelayedRepeatingTask every so often. 
 * You can call it as often or not as you like.
 * It will return straight away and being sync you can call Bukkit methods in your handler.
 */
...
public class Server implements Runnable {
     ...
     */
    protected Server(InetSocketAddress address) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        Server server = new Server(new InetSocketAddress(5555));
        while (true) {
            server.run();
            Thread.sleep(100);
        }
